              ...
              <?php
                ...
                if(is_array($setup1s_slides)){
                    ...
                    **/
                    ...
                    echo '<a class="button pfsearch" id="pf-search-button-manual"><i class="fas fa-search"></i> '.esc_html__('SEARCH', 'pointfindercoreelements').'</a>';
    ...
    class pf_recent_items_w extends WP_Widget {
      use PointFinderOptionFunctions,PointFinderCommonFunctions;
        ...
        public function widget( $args, $instance ) {
            ...
            $pcka_feature = empty($instance['pcka']) ? '' : $instance['pcka'];
            ...
            if (!empty($pcka_feature)) {
              $args2['listingpackagefilter'] = $pcka_feature;
            }
        ...
        public function form( $instance ) {
            ...
            <?php  
              ...
              if ($setup4_membersettings_paymentsystem == '1') {
                ?>
                <p>
                <label for="<?php echo $this->get_field_id('pcka'); ?>"><?php echo esc_html__("Listing Package", "pointfindercoreelements"); ?>:</label>
                <select name="<?php echo $this->get_field_name('pcka'); ?>" id="<?php echo $this->get_field_id('pcka'); ?>"><option value=""><?php echo esc_html__('Please select','pointfindercoreelements'); ?></option>
                <?php
                ...
                foreach ($lpackpostsGet as $lpackpostsGet_single_key => $lpackpostsGet_single_value) {
                  if (isset($lpackpostsGet_single_value->post_title)) {
                    ?>
                    <option value="<?php echo $lpackpostsGet_single_value->ID; ?>" <?php if(isset($instance['pcka'])){selected( $instance['pcka'], $lpackpostsGet_single_value->ID, true);} ?>><?php echo $lpackpostsGet_single_value->post_title; ?></option>
                    <?php
                  }
                }
                ?>
                </select><br/>
                <small><?php echo esc_html__('If this enabled, this widget will show selected listing package listings.','pointfindercoreelements');?></small>
                </p>
                <?php
              }
            ?>
        ...
        public function update( $new_instance, $old_instance ) {
            ...
            $instance['pcka'] = isset($new_instance['pcka'])? $new_instance['pcka']:'';
      ...
      use PointFinderOptionFunctions,PointFinderCommonFunctions;
        ...
        public function widget( $args, $instance ) {
            ...
            if (!empty($scname)) {
              ...
              echo '<div class="widget_pfitem_recent_entries">';
              echo esc_html__( "Please add your twitter name.", "pointfindercoreelements");
              echo '</div>';
            }
