...
$autoplay = $hide_pagination_control = $hide_prev_next_buttons = $title = $slides_per_view = $partial_view = $mode = '';
$posts = array();
...
ob_start();
?>
(function($) {"use strict";$(function() {$("#<?php echo $myrandno;?>").owlCarousel({
