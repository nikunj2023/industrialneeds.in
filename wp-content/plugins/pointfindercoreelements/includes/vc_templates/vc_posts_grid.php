    ...
    <div class="wpb_wrapper">
        ...
        <div class="teaser_grid_container">
            ...
            <ul class="categories_filter vc_clearfix">
                <li class="active"><a href="#" data-filter="*"><?php esc_html_e('All', 'pointfindercoreelements') ?></a></li>
            ...
            <ul class="wpb_thumbnails wpb_thumbnails-fluid vc_clearfix" data-layout-mode="<?php echo $grid_layout_mode ?>">
                ...
                <?php endforeach; ?>
                <?php }else{ ?>
                <li class="<?php echo $this->spanClass(1); ?>"><?php esc_html_e("Nothing found." , "pointfindercoreelements") ?></li>
                <?php }; ?>
            </ul>
        </div>
