    ...
    <div class="wpb_wrapper">
        ...
        <div id="<?php echo $carousel_id ?>"  class="vc-slide vc-image-carousel vc-image-carousel-<?php echo $pf_grid_size;?>">
            ...
            <div class="vc-carousel-inner<?php echo ' '.$pf_classtext;?>">
                ...
                <div class="vc-carousel-slideline"><div class="vc-carousel-slideline-inner owl-carousel owl-theme" id="<?php 
				...
				?>">
                    ...
                    if ($attach_id > 0) {
                        ...
                        $thumbnail = '<img data-no-lazy="1" src="'.$this->assetUrl('vc/no_image.png').'" />';
				   ...
				   if($featured_image_width > 0){
                    ...
                    <?php if ($onclick == 'link_image'){ ?>
                        ...
                        <a class="mfp-image wbp_vc_gallery_pfwrapper <?php echo $pfstyletext?>" href="<?php echo $p_img_large ?>">
                        <div class="pf-pad-area">
                            <?php echo '<img data-no-lazy="1" class="owl-lazy" src="'.$thumbnail.'" alt="">' ?>
                    ...
                    <?php }else{ ?>
                        <?php echo '<img data-no-lazy="1" src="'.$thumbnail.'" alt="" class="owl-lazy '.$pfstyletext.'">' ?>
                    <?php }; ?>
                    </div></div>
                    <?php endforeach; ?>
...
(function($) {
	...
	$(function() {
		...
		$("#<?php echo $myrandno;?>").owlCarousel({
				...
				<?php if($hide_prev_next_buttons !== 'yes'){ echo 'nav : true,';}else{echo 'nav : false,';}?>
				<?php if($hide_pagination_control !== 'yes'){ echo 'dots : true,';}else{echo 'dots : false,';}?>
				<?php if($autoplay == 'yes'){ echo 'autoplay : true,autoplayHoverPause : true,';}else{echo 'autoplay : false,';}?>
			...
			$(window).on("load",function(){
			    setTimeout(function(){
					$(".vc-image-carousel .vc-carousel-slideline-inner .vc-inner img").css("opacity","1").css("width","100%");
			    },150);
			});
