...
while ( $my_query->have_posts() ) {
    ...
    if ( $grid_link != 'link_no' ) {
        $link = '<a class="more-link" href="'. get_permalink($post_id) .'"'.$link_target.' title="'. sprintf( esc_html__( 'Permalink to %s', 'pointfindercoreelements' ), the_title_attribute( 'echo=0' ) ).'">'. esc_html__("Read more", "pointfindercoreelements") .'</a>';
    }
    ...
    if ( $grid_link != 'link_no' ) {
        ...
        if ( $grid_link == 'link_post' ) {
            $link_image_start = '<a class="link_image" href="'.get_permalink($post_id).'"'.$link_target.' title="'.sprintf( esc_html__( 'Permalink to %s', 'pointfindercoreelements' ), the_title_attribute( 'echo=0' ) ).'">';
            $link_title_start = '<a class="link_title" href="'.get_permalink($post_id).'"'.$link_target.' title="'.sprintf( esc_html__( 'Permalink to %s', 'pointfindercoreelements' ), the_title_attribute( 'echo=0' ) ).'">';
        }
            ...
            $link_image_start = '<a class="link_image pf-mfp-image" href="'.$p_link.'"'.$link_target.' title="'.the_title_attribute('echo=0').'">';
            $link_title_start = '<a class="link_title pf-mfp-image" href="'.$p_link.'"'.$link_target.' title="'.the_title_attribute('echo=0').'">';
        }
...
if( $grid_template == 'filtered_grid' && $teasers && !empty($teaser_categories)) {
    ...
    $categories_list_output .= '<li class="active"><a href="#" data-filter="*">' . esc_html__('All', 'pointfindercoreelements') . '</a></li>';
