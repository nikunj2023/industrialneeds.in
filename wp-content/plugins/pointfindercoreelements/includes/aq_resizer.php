                ...
                if ( ! $dims && ( ( ( null === $height && $orig_w == $width ) xor ( null === $width && $orig_h == $height ) ) xor ( $height == $orig_h && $width == $orig_w ) ) ) {
                    ...
                    // Else, we resize the image and return the new resized image url.
                        ...
                        try {
                            ...
                            throw new Aq_Exception( 'Unable to save resized image file: ' . $exception->get_error_message() );
                        }
...
if(!function_exists('pointfinder_aq_resize')) {
     ...
     */
    function pointfinder_aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        /* WPML Fix */
        ...
        $pointfinder_aq_resize = Aq_Resize::getInstance();
        return $pointfinder_aq_resize->process( $url, $width, $height, $crop, $single, $upscale );
    }
}
