...
do_action('pointfinder_before_get_header_page');
get_header();
        ...
        while (have_posts()){
            ...
            if($pf_page_status == 'show'){
                ...
                if(!class_exists('Pointfindercoreelements')){
                   ...
                   if (!has_shortcode( get_the_content() , 'vc_row' ) && !is_elementor_page($post_id)) {
                    ...
                    }elseif(is_elementor_page($post_id)){
                         echo '<section role="main">';
                            echo '<div class="pfelementor">';
                                //echo '<div class="pf-row">';
                                    //echo '<div class="col-lg-12">';
                                        the_content();
                                    //echo '</div>';
                    ...
                    if(PFSAIssetControl('setup4_membersettings_loginregister','','1') == 1 && !is_elementor_page($post_id)){
                       
                        do_action('pointfinder_dashboardpage_hook');
