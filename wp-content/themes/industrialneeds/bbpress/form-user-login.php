...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form pfuaprofileformbb">
	<div class="form-enclose clearfix"><div class="form-section">
		...
		<div class="bbp-password">
			<label for="user_pass" class="lbl-text"><?php _e( 'Password', 'pointfinder' ); ?>: </label>
		...
		<div class="bbp-remember-me">
			...
			<label for="rememberme"><?php _e( 'Keep me signed in', 'pointfinder' ); ?></label>
		</div>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" name="user-submit" class="button submit user-submit"><?php _e( 'Log In', 'pointfinder' ); ?></button>
