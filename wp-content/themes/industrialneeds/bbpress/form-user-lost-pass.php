...
<form method="post" action="<?php bbp_wp_login_action( array( 'action' => 'lostpassword', 'context' => 'login_post' ) ); ?>" class="bbp-login-form pfuaprofileformbb">
	<div class="form-enclose clearfix"><div class="form-section">
		...
		<div class="bbp-username">
			<p>
				<label for="user_login" class="hide lbl-text"><?php _e( 'Username or Email', 'pointfinder' ); ?>: </label>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" name="user-submit" class="button submit user-submit"><?php _e( 'Reset My Password', 'pointfinder' ); ?></button>
